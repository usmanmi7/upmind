    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { title: "MRR", value: `$${stats.mrr.toLocaleString()}`, icon: TrendingUp, color: "from-[#3B82F6] to-[#1E3A8A]", change: "+8.3%" },
          { title: "ARPU", value: `$${stats.arpu.toFixed(2)}`, icon: Users, color: "from-[#1E3A8A] to-[#93C5FD]", change: "+2.1%" },
