...
const chartColors = ["#3B82F6", "#1E3A8A", "#10b981", "#f59e0b", "#ef4444", "#ec4899"]
      ...
      <Tabs defaultValue="users">
        ...
        <TabsContent value="users" className="space-y-4 mt-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { title: "Total Users", value: d.users.total, icon: Users, color: "from-[#3B82F6] to-[#1E3A8A]" },
              { title: "Paid Users", value: d.users.paid, icon: TrendingUp, color: "from-green-500 to-emerald-500" },
              { title: "New (30d)", value: d.users.recent, icon: ArrowUpRight, color: "from-[#1E3A8A] to-[#93C5FD]" },
                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={d.users.growth}>
                      ...
                      <Area type="monotone" dataKey="total" stroke="#3B82F6" fill="#3B82F620" name="Total Users" />
                      <Area type="monotone" dataKey="new" stroke="#1E3A8A" fill="#1E3A8A20" name="New Users" />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
                    ...
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="h-2 bg-muted rounded-full overflow-hidden">
                          <div
                            className="h-full rounded-full bg-gradient-to-r from-[#3B82F6] to-[#1E3A8A]"
        ...
        <TabsContent value="revenue" className="space-y-4 mt-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              { title: "Active Subs", value: d.subscriptions.active, color: "from-[#3B82F6] to-[#1E3A8A]" },
                ...
                <div className="space-y-3">
                  {d.resources.topDownloads.map((r, i) => (
                    <div key={r.id} className="flex items-center gap-3 p-2 rounded-lg bg-muted/50">
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#3B82F6] to-[#1E3A8A] flex items-center justify-center text-white text-sm font-bold shrink-0">
                        {i + 1}
                      </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="p-3 rounded-lg bg-[#3B82F6]/10 text-center">
                      <p className="text-xl font-bold text-[#3B82F6]">{d.messages.unread}</p>
