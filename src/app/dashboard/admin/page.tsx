...
export default function AdminDashboardPage() {
  ...
  const quickActions = [
    { title: "Manage Users", icon: Users, href: "/dashboard/admin/users", color: "from-[#7CFC00] to-[#2D4A2D]" },
    { title: "Add Resource", icon: BookOpen, href: "/dashboard/admin/resources", color: "from-[#2D4A2D] to-[#8FBC8F]" },
