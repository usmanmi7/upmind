        ...
        <div className="lg:col-span-1 space-y-5">
          <div className="p-5 rounded-2xl bg-white/5 border border-white/10">
            ...
            <div className="flex flex-wrap gap-2 mb-3 min-h-[2rem]">
              ...
              {skills.length === 0 && (
                <span className="text-sm text-white/40">No skills added yet.</span>
              )}
            </div>
              ...
              {COMMON_SKILLS.filter(
                ...
                .map((s) => (
                  <button
                    key={s}
                    onClick={() => addSkill(s)}
                    className="text-xs px-2 py-1 rounded-md bg-white/5 text-white/60 border border-white/10 hover:bg-white/10 hover:text-white"
                  >
                    + {s}
                  </button>
                ))}
          ...
          <div className="p-5 rounded-2xl bg-white/5 border border-white/10">
            ...
            <div className="flex flex-wrap gap-2 mb-3 min-h-[2rem]">
              {interests.map((i) => (
                <span
                  key={i}
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 text-sm"
                >
                  {i}
                  <button
              ...
              {interests.length === 0 && (
                <span className="text-sm text-white/40">No interests added yet.</span>
              )}
            </div>
          ...
          <div className="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-4">
            ...
            <div>
              <label className="text-sm text-white/60 flex items-center justify-between mb-1">
            ...
            <div>
              <label className="text-sm text-white/60 block mb-1">Difficulty preference</label>
              <select
                value={difficulty}
          ...
          {!hasRun ? (
            ...
            <div className="h-full flex items-center justify-center p-12 rounded-2xl bg-white/5 border border-dashed border-white/15 text-center">
              <div>
                ...
                <p className="text-white/60">Try adding more skills or broadening your interests.</p>
              </div>
            </div>
          ) : (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-white/50">Sorted by match score</span>
              </div>
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-white/60 mb-3 line-clamp-2">{problem.summary}</p>
          ...
          <div className="flex items-center gap-4 text-xs text-white/50 pt-3 border-t border-white/5">
