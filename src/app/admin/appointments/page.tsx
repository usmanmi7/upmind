...
const statusColors: Record<string, string> = {
  SCHEDULED: "bg-[#3B82F6]/20 text-[#3B82F6] border-[#3B82F6]/30",
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        {[
          { title: "Total", value: total, icon: CalendarDays, color: "from-[#3B82F6] to-[#1E3A8A]" },
          { title: "Scheduled", value: stats.scheduled, icon: Clock, color: "from-[#1E3A8A] to-[#93C5FD]" },
