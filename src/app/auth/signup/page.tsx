...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      // New OAuth users land on onboarding to complete their profile;
      // returning users will be redirected to /dashboard by NextAuth's
      // callback URL after the OAuth round-trip.
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-[#0A1228] dark:via-[#0F1B3D] dark:to-[#1E3A8A] p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <p className="text-center text-xs text-muted-foreground mt-4">
          ...
          <Link href="#" className="underline hover:text-foreground transition-smooth">
            Terms of Service
          </Link>{" "}
          and{" "}
          <Link href="#" className="underline hover:text-foreground transition-smooth">
