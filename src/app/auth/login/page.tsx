...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // OAuth requires a full redirect (not client-side), so we pass
      // callbackUrl to land users on the dashboard after sign-in.
      // `redirect: false` does NOT work for OAuth providers in next-auth v4.
