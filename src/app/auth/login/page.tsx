      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="glass border-0 shadow-xl shadow-black/5 dark:shadow-black/20">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>
              Sign in to your Upmind account
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs text-blue-500 hover:text-blue-600 transition-smooth"
                  >
                    Forgot password?
                  </Link>
                </div>
          ...
          <CardFooter className="justify-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link
                href="/auth/signup"
                className="text-blue-500 hover:text-blue-600 font-medium transition-smooth"
              >
                Sign Up
              </Link>
            </p>
