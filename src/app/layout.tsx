...
export const metadata: Metadata = {
  ...
  description: "We help startups and growing teams validate ideas, scale products, and make data-driven decisions. Clear insights. Real strategy. Sustainable growth.",
